...
const NavBar = ({ auth, logout }) => (<div className="navbar">
    <div className="container">
        <ul className="navbar-container">
            ...
            {!auth.isAuthenticated && <Fragment><li><Link className="navbar-item" to="/register">Register</Link></li>
            <li><Link className="navbar-item" to="/login">Login</Link></li></Fragment>}
            {auth.isAuthenticated && <Fragment><li><Link className="navbar-item" to="/poll/new">Create Poll</Link></li>
            <li><a className="navbar-item" onClick={logout}>Logout</a></li></Fragment>}
        </ul>
